...
SCHEME_XC="Starburst-cal"
BUILD_CONFIG="Debug"
FEATURES_PATH="features"
ARCHITECTURE_SELECTED="i386 x86_64"
APPNAME="Starburst-cal"
...
echo DEVICE_TARGET='iPhone 6s Plus (9.0)' APP_BUNDLE_PATH=$APP_BUNDLE_PATH_VAR bundle exec cucumber -f rerun --out rerun.txt -p ios --tag $2
DEVICE_TARGET='iPhone 6s Plus (9.0)' APP_BUNDLE_PATH=$APP_BUNDLE_PATH_VAR bundle exec cucumber -f rerun --out rerun.txt -p ios --tag $2